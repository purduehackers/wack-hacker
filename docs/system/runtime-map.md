...
| `packages/agents` | Eve 0.29.5 application   | Session/server lifetime | Model sessions, channel state, subagents, tools, skills, policy, approvals, durable schedule dispatch, bot Sandbox supervision | discord.js, the gateway, rendering the agent replies |
