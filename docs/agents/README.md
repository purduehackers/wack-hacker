...
The orchestrator is **flat**: all tools are visible from the start, and there's no skill-disclosure indirection. The skill system only kicks in *inside* the subagents that the orchestrator delegates to.
