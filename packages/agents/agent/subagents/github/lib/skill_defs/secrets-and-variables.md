...
Use when the user wants to view, create, update, or delete secrets or variables.

## Relevant tools

`list_repo_secrets`, `create_or_update_repo_secret`, `delete_repo_secret`, `list_repo_variables`, `create_or_update_repo_variable`, `delete_repo_variable`, `list_org_secrets`, `create_or_update_org_secret`, `delete_org_secret`, `list_org_variables`, `create_or_update_org_variable`, `delete_org_variable`
