...
Use when the user wants to create/update an initiative or inspect its history.

## Relevant tools

`create_initiative`, `update_initiative`, `list_initiatives`, `query_initiative_activity`
