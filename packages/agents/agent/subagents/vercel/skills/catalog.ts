...
export const VERCEL_SKILL_DEFINITIONS = [
  ...
  },
  {
    name: "edge-platform",
    description:
      "Edge Config stores/items/tokens/backups, edge cache invalidation, native Vercel feature flags.",
    criteria:
      "Use when the user asks about Edge Config, cache invalidation (by tag or image URL), or Vercel's native feature flags and SDK keys.",
    minRole: "organizer",
    tools: [
      "list_edge_configs",
      "get_edge_config",
