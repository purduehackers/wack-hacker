...
`list_integration_configurations`, `get_integration_configuration`, `get_integration_configuration_products`, `get_integration_billing_plans`, `delete_integration_configuration`, `create_integration_store_direct`, `connect_integration_resource_to_project`, `list_integration_resources`, `get_integration_resource`, `delete_integration_resource`, `list_git_namespaces`, `search_git_repos`
