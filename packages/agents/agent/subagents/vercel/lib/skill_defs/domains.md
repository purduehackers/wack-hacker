...
`list_aliases`, `get_alias`, `list_deployment_aliases`, `assign_alias`, `delete_alias`, `list_domains`, `get_domain`, `get_domain_config`, `delete_domain`, `list_dns_records`, `remove_dns_record`, `list_supported_tlds`, `check_domain_availability`, `get_domain_price`, `get_domain_auth_code`, `get_domain_transfer_in_status`, `get_registrar_order`, `get_cert`, `issue_cert`, `remove_cert`
