...
`get_firewall_config`, `get_active_attack_status`, `update_attack_challenge_mode`, `list_bypass_ips`, `list_firewall_events`, `list_auth_tokens`, `get_auth_token`, `delete_auth_token`
