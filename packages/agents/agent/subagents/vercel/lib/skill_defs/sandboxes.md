...
`list_sandboxes`, `get_sandbox`, `stop_sandbox`, `extend_sandbox_timeout`, `list_sandbox_commands`, `get_sandbox_command`, `get_sandbox_command_logs`, `kill_sandbox_command`, `list_sandbox_snapshots`, `get_sandbox_snapshot`, `delete_sandbox_snapshot`
