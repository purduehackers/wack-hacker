...
`list_hack_night_sessions`, `get_hack_night_session`, `create_hack_night_session`, `update_hack_night_session`, `delete_hack_night_session`, `publish_hack_night_session`, `unpublish_hack_night_session`
