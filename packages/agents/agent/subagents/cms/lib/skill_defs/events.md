...
`list_events`, `get_event`, `create_event`, `update_event`, `delete_event`, `publish_event`, `unpublish_event`, `send_blast`, `list_rsvps`, `get_rsvp`, `create_rsvp`, `update_rsvp`, `delete_rsvp`, `list_emails`, `get_email`, `create_email`, `update_email`, `delete_email`, `send_email`
