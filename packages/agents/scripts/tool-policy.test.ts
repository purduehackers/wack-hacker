...
const { CMS_RUNTIME } = await import("../agent/subagents/cms/lib/runtime.ts");
...
const { DISCORD_RUNTIME } = await import("../agent/subagents/discord/lib/runtime.ts");
...
const { FIGMA_RUNTIME } = await import("../agent/subagents/figma/lib/runtime.ts");
...
const { FINANCE_RUNTIME } = await import("../agent/subagents/finance/lib/runtime.ts");
...
const { GITHUB_RUNTIME } = await import("../agent/subagents/github/lib/runtime.ts");
...
const { LINEAR_RUNTIME } = await import("../agent/subagents/linear/lib/runtime.ts");
...
const { NOTION_RUNTIME } = await import("../agent/subagents/notion/lib/runtime.ts");
...
const { OUTREACH_RUNTIME } = await import("../agent/subagents/outreach/lib/runtime.ts");
...
const { SENTRY_RUNTIME } = await import("../agent/subagents/sentry/lib/runtime.ts");
...
const { SHOPPING_RUNTIME } = await import("../agent/subagents/shopping/lib/runtime.ts");
...
const { VERCEL_RUNTIME } = await import("../agent/subagents/vercel/lib/runtime.ts");
...
const adapters = [
  {
    ...
    catalog: cmsCatalog,
    tools: CMS_TOOLS,
    visible: CMS_RUNTIME.visibleToolNames,
    counts: [16, 49, 54],
  },
  {
    name: "discord",
    ...
    tools: DISCORD_TOOLS,
    visible: DISCORD_RUNTIME.visibleToolNames,
    counts: [18, 56, 68],
  },
  {
    name: "figma",
    ...
    tools: FIGMA_TOOLS,
    visible: FIGMA_RUNTIME.visibleToolNames,
    counts: [20, 28, 33],
  },
  {
    name: "finance",
    ...
    tools: FINANCE_TOOLS,
    visible: FINANCE_RUNTIME.visibleToolNames,
    counts: [16, 16, 16],
  },
  {
    name: "github",
    ...
    tools: GITHUB_TOOLS,
    visible: GITHUB_RUNTIME.visibleToolNames,
    counts: [49, 109, 119],
  },
  {
    name: "linear",
    ...
    tools: LINEAR_TOOLS,
    visible: LINEAR_RUNTIME.visibleToolNames,
    counts: [23, 55, 64],
  },
  {
    name: "notion",
    ...
    tools: NOTION_TOOLS,
    visible: NOTION_RUNTIME.visibleToolNames,
    counts: [13, 24, 24],
  },
  {
    name: "outreach",
    ...
    visible: OUTREACH_RUNTIME.visibleToolNames,
    counts: [18, 38, 41],
  },
  {
    name: "sentry",
    ...
    tools: SENTRY_TOOLS,
    visible: SENTRY_RUNTIME.visibleToolNames,
    counts: [45, 55, 68],
  },
  {
    name: "shopping",
    ...
    visible: SHOPPING_RUNTIME.visibleToolNames,
    counts: [2, 6, 6],
  },
  {
    name: "vercel",
    ...
    tools: VERCEL_TOOLS,
    visible: VERCEL_RUNTIME.visibleToolNames,
    counts: [104, 166, 166],
  },
] as const;
