...
export const delete_rolling_release_config = approval(
  tool({
...
export const approve_rolling_release_stage = approval(
  tool({
    description:
...
export const complete_rolling_release = approval(
  tool({
...
export const delete_project_check = approval(
  tool({
