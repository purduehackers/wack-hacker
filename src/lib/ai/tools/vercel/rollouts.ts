...
export const get_rolling_release = access(
  { risk: "read" },
  tool({
...
export const get_rolling_release_config = access(
  { risk: "read" },
  tool({
...
export const get_rolling_release_billing_status = access(
  { risk: "read" },
  tool({
...
export const delete_rolling_release_config = access(
  { risk: "destructive" },
  tool({
...
export const approve_rolling_release_stage = access(
  { risk: "destructive" },
  tool({
    description:
      "Advance an in-flight rolling release to the next stage. Shifts production traffic.",
...
export const complete_rolling_release = access(
  { risk: "destructive" },
  tool({
...
export const list_project_checks = access(
  { risk: "read" },
  tool({
...
export const get_project_check = access(
  { risk: "read" },
  tool({
...
export const delete_project_check = access(
  { risk: "destructive" },
  tool({
...
export const list_check_runs = access(
  { risk: "read" },
  tool({
...
export const list_deployment_check_runs = access(
  { risk: "read" },
  tool({
...
export const get_deployment_check_run = access(
  { risk: "read" },
  tool({
