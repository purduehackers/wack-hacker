...
export const get_runtime_logs = access(
  { risk: "read" },
  tool({
    description:
...
export const list_log_drains = access(
  { risk: "read" },
  tool({
...
export const get_log_drain = access(
  { risk: "read" },
  tool({
...
export const delete_configurable_log_drain = access(
  { risk: "destructive" },
  tool({
...
export const list_integration_log_drains = access(
  { risk: "read" },
  tool({
...
export const delete_integration_log_drain = access(
  { risk: "destructive" },
  tool({
...
export const list_drains = access(
  { risk: "read" },
  tool({
    description:
...
export const delete_drain = access(
  { risk: "destructive" },
  tool({
...
export const get_observability_config = access(
  { risk: "read" },
  tool({
...
export const update_observability_config = access(
  { risk: "write" },
  tool({
...
export const artifacts_status = access(
  { risk: "read" },
  tool({
...
export const artifact_exists = access(
  { risk: "read" },
  tool({
...
export const artifact_query = access(
  { risk: "read" },
  tool({
