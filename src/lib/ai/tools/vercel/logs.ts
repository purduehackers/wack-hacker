...
/** @destructive Deletes a configurable log drain — stops log forwarding. */
export const delete_configurable_log_drain = tool({
...
/** @destructive Deletes an integration-installed log drain. */
export const delete_integration_log_drain = tool({
...
/** @destructive Deletes a data drain. */
export const delete_drain = tool({
...
/** @destructive Enables/disables API Observability Plus for a project. */
