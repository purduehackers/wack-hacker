...
export const list_team_members = access(
  { risk: "read" },
  tool({
...
export const remove_team_member = access(
  { risk: "destructive" },
  tool({
...
export const delete_team_invite_code = access(
  { risk: "destructive" },
  tool({
...
export const list_access_groups = access(
  { risk: "read" },
  tool({
...
export const get_access_group = access(
  { risk: "read" },
  tool({
...
export const delete_access_group = access(
  { risk: "destructive" },
  tool({
...
export const list_access_group_members = access(
  { risk: "read" },
  tool({
...
export const list_webhooks = access(
  { risk: "read" },
  tool({
...
export const list_project_routes = access(
  { risk: "read" },
  tool({
...
export const list_project_route_versions = access(
  { risk: "read" },
  tool({
...
export const list_connect_networks = access(
  { risk: "read" },
  tool({
...
export const get_connect_network = access(
  { risk: "read" },
  tool({
...
export const delete_connect_network = access(
  { risk: "destructive" },
  tool({
...
export const list_microfrontend_groups = access(
  { risk: "read" },
  tool({
...
export const list_billing_charges = access(
  { risk: "read" },
  tool({
    description:
...
export const list_contract_commitments = access(
  { risk: "read" },
  tool({
...
export const list_custom_environments = access(
  { risk: "read" },
  tool({
    description:
...
export const get_custom_environment = access(
  { risk: "read" },
  tool({
...
export const remove_custom_environment = access(
  { risk: "destructive" },
  tool({
