...
export const list_integration_configurations = access(
  { risk: "read" },
  tool({
    description:
...
export const get_integration_configuration = access(
  { risk: "read" },
  tool({
...
export const get_integration_configuration_products = access(
  { risk: "read" },
  tool({
    description:
      "List products offered by an installed integration — e.g. Postgres / Redis / Blob.",
    inputSchema: z.object({ configuration_id: z.string() }),
    execute: async ({ configuration_id }) => {
...
export const get_integration_billing_plans = access(
  { risk: "read" },
  tool({
    description:
...
export const delete_integration_configuration = access(
  { risk: "destructive" },
  tool({
...
export const create_integration_store_direct = access(
  { risk: "destructive" },
  tool({
    description:
...
export const connect_integration_resource_to_project = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_integration_resources = access(
  { risk: "read" },
  tool({
    description:
...
export const get_integration_resource = access(
  { risk: "read" },
  tool({
...
export const delete_integration_resource = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_git_namespaces = access(
  { risk: "read" },
  tool({
    description:
...
export const search_git_repos = access(
  { risk: "read" },
  tool({
    description:
