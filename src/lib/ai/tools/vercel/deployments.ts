...
export const list_deployments = access(
  { risk: "read" },
  tool({
    description:
...
export const get_deployment = access(
  { risk: "read" },
  tool({
    description:
    ...
    inputSchema: z.object({
      id_or_url: z
        .string()
        .describe("Deployment id (dpl_…) or hostname (my-app-abc123.vercel.app)"),
...
export const get_deployment_events = access(
  { risk: "read" },
  tool({
    description:
...
export const list_deployment_files = access(
  { risk: "read" },
  tool({
...
export const get_deployment_file_contents = access(
  { risk: "read" },
  tool({
    description:
      "Get the contents of a specific file from a deployment. Response is base64-encoded.",
    inputSchema: z.object({
      deployment_id: z.string(),
      file_id: z.string(),
...
export const cancel_deployment = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_deployment = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_integration_deployment_action = access(
  { risk: "write" },
  tool({
    description:
...
export const promote_deployment = access(
  { risk: "destructive" },
  tool({
    description:
...
export const rollback_deployment = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_rollback_description = access(
  { risk: "write" },
  tool({
