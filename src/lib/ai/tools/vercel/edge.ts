...
export const list_edge_configs = access(
  { risk: "read" },
  tool({
...
export const get_edge_config = access(
  { risk: "read" },
  tool({
...
export const create_edge_config = access(
  { risk: "write" },
  tool({
...
export const update_edge_config = access(
  { risk: "destructive" },
  tool({
...
export const delete_edge_config = access(
  { risk: "destructive" },
  tool({
...
export const list_edge_config_items = access(
  { risk: "read" },
  tool({
...
export const get_edge_config_item = access(
  { risk: "read" },
  tool({
...
export const patch_edge_config_items = access(
  { risk: "destructive" },
  tool({
    description:
...
export const get_edge_config_schema = access(
  { risk: "read" },
  tool({
...
export const delete_edge_config_schema = access(
  { risk: "destructive" },
  tool({
...
export const list_edge_config_tokens = access(
  { risk: "read" },
  tool({
    description:
...
export const get_edge_config_token = access(
  { risk: "read" },
  tool({
    description:
...
export const create_edge_config_token = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_edge_config_tokens = access(
  { risk: "destructive" },
  tool({
...
export const list_edge_config_backups = access(
  { risk: "read" },
  tool({
...
export const get_edge_config_backup = access(
  { risk: "read" },
  tool({
...
export const invalidate_edge_cache_by_tags = access(
  { risk: "write" },
  tool({
...
export const dangerously_delete_edge_cache_by_tags = access(
  { risk: "destructive" },
  tool({
    description:
...
export const invalidate_edge_cache_by_src_images = access(
  { risk: "write" },
  tool({
...
export const dangerously_delete_edge_cache_by_src_images = access(
  { risk: "destructive" },
  tool({
...
export const list_flags = access(
  { risk: "read" },
  tool({
...
export const delete_flag = access(
  { risk: "destructive" },
  tool({
...
export const list_flag_versions = access(
  { risk: "read" },
  tool({
...
export const get_flag_settings = access(
  { risk: "read" },
  tool({
...
export const list_team_flag_settings = access(
  { risk: "read" },
  tool({
...
export const list_team_flags = access(
  { risk: "read" },
  tool({
...
export const list_flag_segments = access(
  { risk: "read" },
  tool({
...
export const get_flag_segment = access(
  { risk: "read" },
  tool({
...
export const delete_flag_segment = access(
  { risk: "destructive" },
  tool({
...
export const get_deployment_feature_flags = access(
  { risk: "read" },
  tool({
...
export const list_sdk_keys = access(
  { risk: "read" },
  tool({
...
export const create_sdk_key = access(
  { risk: "destructive" },
  tool({
...
export const delete_sdk_key = access(
  { risk: "destructive" },
  tool({
