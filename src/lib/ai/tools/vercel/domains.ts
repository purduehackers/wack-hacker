...
export const list_aliases = access(
  { risk: "read" },
  tool({
    description:
...
export const list_deployment_aliases = access(
  { risk: "read" },
  tool({
...
export const assign_alias = access(
  { risk: "destructive" },
  tool({
...
export const delete_alias = access(
  { risk: "destructive" },
  tool({
...
export const list_domains = access(
  { risk: "read" },
  tool({
...
export const get_domain = access(
  { risk: "read" },
  tool({
...
export const get_domain_config = access(
  { risk: "read" },
  tool({
    description:
...
export const delete_domain = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_dns_records = access(
  { risk: "read" },
  tool({
...
export const remove_dns_record = access(
  { risk: "destructive" },
  tool({
...
export const list_supported_tlds = access(
  { risk: "read" },
  tool({
...
export const check_domain_availability = access(
  { risk: "read" },
  tool({
...
export const get_domain_price = access(
  { risk: "read" },
  tool({
...
export const get_domain_auth_code = access(
  { risk: "destructive" },
  tool({
...
export const get_domain_transfer_in_status = access(
  { risk: "read" },
  tool({
...
export const get_registrar_order = access(
  { risk: "read" },
  tool({
...
export const issue_cert = access(
  { risk: "destructive" },
  tool({
...
export const remove_cert = access(
  { risk: "destructive" },
  tool({
