...
export const pause_project = access(
  { risk: "destructive" },
  tool({
...
export const unpause_project = access(
  { risk: "destructive" },
  tool({
...
export const create_project_transfer_request = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_project_env_vars = access(
  { risk: "read" },
  tool({
    description:
...
export const get_project_env_var = access(
  { risk: "read" },
  tool({
    description:
...
export const create_project_env_vars = access(
  { risk: "destructive" },
  tool({
    description:
...
export const edit_project_env_var = access(
  { risk: "destructive" },
  tool({
...
export const remove_project_env_var = access(
  { risk: "destructive" },
  tool({
...
export const list_project_domains = access(
  { risk: "read" },
  tool({
    description:
...
export const get_project_domain = access(
  { risk: "read" },
  tool({
...
export const remove_project_domain = access(
  { risk: "destructive" },
  tool({
...
export const verify_project_domain = access(
  { risk: "write" },
  tool({
...
export const list_promote_aliases = access(
  { risk: "read" },
  tool({
    description:
...
export const list_project_members = access(
  { risk: "read" },
  tool({
...
export const remove_project_member = access(
  { risk: "destructive" },
  tool({
