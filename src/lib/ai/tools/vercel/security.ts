...
export const get_firewall_config = access(
  { risk: "read" },
  tool({
    description:
...
export const get_active_attack_status = access(
  { risk: "read" },
  tool({
...
export const update_attack_challenge_mode = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_bypass_ips = access(
  { risk: "read" },
  tool({
...
export const list_firewall_events = access(
  { risk: "read" },
  tool({
    description:
...
export const list_auth_tokens = access(
  { risk: "read" },
  tool({
...
export const get_auth_token = access(
  { risk: "read" },
  tool({
...
export const delete_auth_token = access(
  { risk: "destructive" },
  tool({
