...
export const list_contacts = access(
  { risk: "read" },
  tool({
...
export const get_contact = access(
  { risk: "read" },
  tool({
...
export const create_contact = access(
  { risk: "write" },
  tool({
...
export const archive_contact = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_contact_status = access(
  { risk: "write" },
  tool({
...
export const update_contact_email = access(
  { risk: "write" },
  tool({
...
export const set_contact_last_outreach = access(
  { risk: "write" },
  tool({
