...
export const list_deals = access(
  { risk: "read" },
  tool({
...
export const create_deal = access(
  { risk: "write" },
  tool({
...
export const update_deal_stage = access(
  { risk: "write" },
  tool({
...
export const update_deal = access(
  { risk: "write" },
  tool({
