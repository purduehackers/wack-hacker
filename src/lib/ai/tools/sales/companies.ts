...
export const list_companies = access(
  { risk: "read" },
  tool({
...
export const get_company = access(
  { risk: "read" },
  tool({
...
export const create_company = access(
  { risk: "write" },
  tool({
...
export const archive_company = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_company_status = access(
  { risk: "write" },
  tool({
...
export const update_company_email = access(
  { risk: "write" },
  tool({
...
export const update_company_next_followup = access(
  { risk: "write" },
  tool({
...
export const set_company_last_outreach = access(
  { risk: "write" },
  tool({
