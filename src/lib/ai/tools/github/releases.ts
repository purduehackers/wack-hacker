...
export const list_releases = access(
  { risk: "read" },
  tool({
    description:
...
export const get_release = access(
  { risk: "read" },
  tool({
    description:
      "Get full details for a release including its body, assets, author, and timestamps.",
    inputSchema: z.object({
      repo: z.string().describe("Repository name"),
...
export const create_release = access(
  { risk: "write" },
  tool({
    description:
...
export const update_release = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_release = access(
  { risk: "destructive" },
  tool({
...
export const list_release_assets = access(
  { risk: "read" },
  tool({
    description:
