...
export const create_ref = access(
  { risk: "write" },
  tool({
    description:
...
export const update_ref = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_ref = access(
  { risk: "destructive" },
  tool({
    description:
