...
export const get_file_content = access(
  { risk: "read" },
  tool({
...
export const create_or_update_file = access(
  { risk: "write" },
  tool({
...
export const delete_file = access(
  { risk: "destructive" },
  tool({
...
export const get_directory_tree = access(
  { risk: "read" },
  tool({
...
export const list_commits = access(
  { risk: "read" },
  tool({
...
export const get_commit = access(
  { risk: "read" },
  tool({
...
export const compare_commits = access(
  { risk: "read" },
  tool({
