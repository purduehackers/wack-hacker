...
export const list_environments = access(
  { risk: "read" },
  tool({
    description:
...
export const get_environment = access(
  { risk: "read" },
  tool({
...
export const create_or_update_environment = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_environment = access(
  { risk: "destructive" },
  tool({
