...
export const create_repository = access(
  { risk: "write" },
  tool({
...
export const update_repository = access(
  { risk: "destructive" },
  tool({
...
export const delete_repository = access(
...
export const archive_repository = access(
  { risk: "destructive" },
  tool({
    description:
...
export const transfer_repository = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_branches = access(
  { risk: "read" },
  tool({
...
export const get_branch_protection = access(
  { risk: "read" },
  tool({
...
export const set_branch_protection = access(
  { risk: "destructive" },
  tool({
...
export const delete_branch_protection = access(
  { risk: "destructive" },
  tool({
