...
export const create_issue = access(
  { risk: "write" },
  tool({
...
export const update_issue = access(
  { risk: "write" },
  tool({
...
export const lock_issue = access(
...
export const unlock_issue = access(
  { risk: "write" },
  tool({
...
export const add_assignees = access(
  { risk: "write" },
  tool({
...
export const remove_assignees = access(
  { risk: "write", confirm: "self" },
  tool({
...
export const list_issue_comments = access(
  { risk: "read" },
  tool({
...
export const create_issue_comment = access(
  { risk: "write" },
  tool({
...
export const update_issue_comment = access(
  { risk: "write" },
  tool({
...
export const delete_issue_comment = access(
  { risk: "destructive" },
  tool({
...
export const manage_labels = access(
  { risk: "destructive" },
  tool({
...
export const manage_milestones = access(
  { risk: "destructive" },
  tool({
