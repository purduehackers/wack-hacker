...
export const list_workflows = access(
  { risk: "read" },
  tool({
...
export const list_workflow_runs = access(
  { risk: "read" },
  tool({
...
export const get_workflow_run = access(
  { risk: "read" },
  tool({
...
export const trigger_workflow = access(
  { risk: "destructive" },
  tool({
...
export const cancel_workflow_run = access(
  { risk: "destructive" },
  tool({
...
export const rerun_workflow = access(
  { risk: "destructive" },
  tool({
...
export const list_workflow_jobs = access(
  { risk: "read" },
  tool({
...
export const download_artifact = access(
  { risk: "read" },
  tool({
