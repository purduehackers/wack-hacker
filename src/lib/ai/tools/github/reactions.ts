...
export const add_issue_reaction = access(
  { risk: "write" },
  tool({
...
export const remove_issue_reaction = access(
  { risk: "destructive" },
  tool({
...
export const add_comment_reaction = access(
  { risk: "write" },
  tool({
...
export const remove_comment_reaction = access(
  { risk: "destructive" },
  tool({
