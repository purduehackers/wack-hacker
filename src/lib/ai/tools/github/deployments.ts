...
export const create_deployment = access(
  { risk: "destructive" },
  tool({
...
export const create_deployment_status = access(
  { risk: "write" },
  tool({
...
export const get_pages_info = access(
  { risk: "read" },
  tool({
...
export const list_pages_builds = access(
  { risk: "read" },
  tool({
...
export const trigger_pages_build = access(
  { risk: "destructive" },
  tool({
