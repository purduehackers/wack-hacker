...
export const create_pull_request = access(
  { risk: "write" },
  tool({
...
export const update_pull_request = access(
  { risk: "write" },
  tool({
...
export const merge_pull_request = access(
  { risk: "destructive" },
  tool({
...
export const close_pull_request = access(
...
export const request_reviewers = access(
  { risk: "write" },
  tool({
...
export const remove_requested_reviewers = access(
  { risk: "destructive" },
  tool({
...
export const list_pr_reviews = access(
  { risk: "read" },
  tool({
...
export const create_pr_review = access(
  { risk: "write" },
  tool({
...
export const list_pr_files = access(
  { risk: "read" },
  tool({
...
export const list_pr_comments = access(
  { risk: "read" },
  tool({
