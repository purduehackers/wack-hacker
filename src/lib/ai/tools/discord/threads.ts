...
export const list_threads = access(
  { risk: "read" },
  tool({
    description:
...
export const create_thread = access(
  { risk: "write" },
  tool({
    description:
    ...
    execute: async ({
      ...
      if (message_id) {
        ...
        const thread = (await discord.post(Routes.threads(channel_id, message_id), {
          body,
        })) as any;
...
export const edit_thread = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_thread = access(
  { risk: "destructive" },
  tool({
    description:
