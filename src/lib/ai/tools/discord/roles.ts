...
export const create_role = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_role = access(
  { risk: "destructive" },
  tool({
    description:
...
export const assign_role = access(
  { risk: "destructive" },
  tool({
    description:
...
export const remove_role = access(
  { risk: "destructive" },
  tool({
    description:
