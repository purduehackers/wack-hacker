...
export const ban_member = access(
...
export const unban_member = access(
...
export const kick_member = access(
  { risk: "destructive", minRole: "admin", confirm: "second-party" },
  tool({
    description:
...
export const timeout_member = access(
  { risk: "destructive", minRole: "admin" },
  tool({
    description:
...
export const clear_timeout = access(
  { risk: "destructive", minRole: "admin" },
  tool({
    description:
