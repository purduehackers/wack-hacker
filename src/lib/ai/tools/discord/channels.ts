...
export const create_channel = access(
  { risk: "write" },
  tool({
    description:
...
export const edit_channel = access(
  { risk: "write" },
  tool({
    description:
...
export const get_channel = access(
  { risk: "read" },
  tool({
    description:
...
export const follow_announcement_channel = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_channel = access(
  { risk: "destructive" },
  tool({
    description:
