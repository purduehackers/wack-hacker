...
export const list_members = access(
  { risk: "read" },
  tool({
    description:
...
export const get_member = access(
  { risk: "read" },
  tool({
...
/** Create a new team. */
export const create_team = access(
...
export const update_team = access(
  { risk: "write", minRole: "admin" },
  tool({
...
/** Delete a team. */
export const delete_team = access(
...
export const update_member_role = access(
  { risk: "destructive", minRole: "admin" },
  tool({
    description:
