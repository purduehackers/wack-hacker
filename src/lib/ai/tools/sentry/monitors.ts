...
export const list_monitors = access(
  { risk: "read" },
  tool({
    description:
...
export const get_monitor = access(
  { risk: "read" },
  tool({
    description:
...
export const list_monitor_checkins = access(
  { risk: "read" },
  tool({
    description:
...
export const update_monitor = access(
  { risk: "write" },
  tool({
...
export const delete_monitor = access(
