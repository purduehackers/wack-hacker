...
export const list_alert_rules = access(
  { risk: "read" },
  tool({
...
export const get_alert_rule = access(
  { risk: "read" },
  tool({
    description:
      "Get full details for a Sentry issue alert rule, including conditions and actions.",
    inputSchema: z.object({
      project_slug: z.string().describe("Project slug"),
...
export const create_alert_rule = access(
  { risk: "write" },
  tool({
    description:
...
export const update_alert_rule = access(
  { risk: "write" },
  tool({
...
export const delete_alert_rule = access(
...
export const list_metric_alert_rules = access(
  { risk: "read" },
  tool({
    description:
...
export const get_metric_alert_rule = access(
  { risk: "read" },
  tool({
    description:
