...
export const list_service_accounts = access(
  { risk: "read" },
  tool({
    description:
...
export const get_service_account = access(
  { risk: "read" },
  tool({
...
export const create_service_account = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_service_account = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_service_account = access(
  { risk: "destructive" },
  tool({
    description:
