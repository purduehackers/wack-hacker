...
export const list_ugrants = access(
  { risk: "read" },
  tool({
    description:
...
export const get_ugrant = access(
  { risk: "read" },
  tool({
...
export const create_ugrant = access(
  { risk: "write" },
  tool({
    description:
...
export const update_ugrant = access(
  { risk: "write" },
  tool({
...
export const delete_ugrant = access(
  { risk: "destructive" },
  tool({
...
export const publish_ugrant = access(
  { risk: "destructive" },
  tool({
...
export const unpublish_ugrant = access(
  { risk: "destructive" },
  tool({
