...
export const list_hack_night_sessions = access(
  { risk: "read" },
  tool({
    description:
...
export const get_hack_night_session = access(
  { risk: "read" },
  tool({
...
export const create_hack_night_session = access(
  { risk: "write" },
  tool({
    description:
...
export const update_hack_night_session = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_hack_night_session = access(
  { risk: "destructive" },
  tool({
...
export const publish_hack_night_session = access(
  { risk: "destructive" },
  tool({
...
export const unpublish_hack_night_session = access(
  { risk: "destructive" },
  tool({
