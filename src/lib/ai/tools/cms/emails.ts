...
export const list_emails = access(
  { risk: "read" },
  tool({
    description:
...
export const create_email = access(
  { risk: "write" },
  tool({
    description:
...
export const update_email = access(
  { risk: "write" },
  tool({
    description:
...
export const delete_email = access(
  { risk: "destructive" },
  tool({
...
export const send_email = access(
  { risk: "destructive" },
  tool({
    description:
