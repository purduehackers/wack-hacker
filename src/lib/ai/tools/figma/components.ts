...
export const list_team_components = access(
  { risk: "read" },
  tool({
...
export const list_file_components = access(
  { risk: "read" },
  tool({
...
export const get_component = access(
  { risk: "read" },
  tool({
...
export const list_team_component_sets = access(
  { risk: "read" },
  tool({
    description:
...
export const get_component_set = access(
  { risk: "read" },
  tool({
...
export const list_team_styles = access(
  { risk: "read" },
  tool({
...
export const list_file_styles = access(
  { risk: "read" },
  tool({
