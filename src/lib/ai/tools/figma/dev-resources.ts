...
export const list_dev_resources = access(
  { risk: "read" },
  tool({
    description:
...
export const create_dev_resources = access(
  { risk: "write" },
  tool({
    description:
...
export const update_dev_resource = access(
  { risk: "write" },
  tool({
...
export const delete_dev_resource = access(
  { risk: "destructive" },
  tool({
