...
export const create_page = access(
  { risk: "write" },
  tool({
...
export const update_page = access(
  { risk: "destructive" },
  tool({
...
export const retrieve_page_property = access(
  { risk: "read" },
  tool({
...
export const read_page_content = access(
  { risk: "read" },
  tool({
...
export const archive_page = access(
  { risk: "destructive" },
  tool({
    description:
...
export const update_page_content = access(
  { risk: "write" },
  tool({
    ...
    inputSchema: z.object({
      ...
      new_content: z
        .string()
        .optional()
        .describe("Full markdown content (for replace_content mode)"),
