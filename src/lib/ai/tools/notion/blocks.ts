...
export const retrieve_block = access(
  { risk: "read" },
  tool({
    description:
...
export const update_block = access(
  { risk: "destructive" },
  tool({
    description:
...
export const delete_block = access(
  { risk: "destructive" },
  tool({
    description:
...
export const list_block_children = access(
  { risk: "read" },
  tool({
    description:
...
export const append_block_children = access(
  { risk: "write" },
  tool({
    description:
