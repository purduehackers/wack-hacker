...
export const search_entities = access(
  { risk: "read" },
  tool({
    description:
...
export const retrieve_entities = access(
  { risk: "read" },
  tool({
    description:
...
export const suggest_property_values = access(
  { risk: "read" },
  tool({
    description:
...
export const aggregate_issues = access(
  { risk: "read" },
  tool({
    description:
