...
export const list_users = access(
  { risk: "read" },
  tool({
    description:
...
export const get_user_teams = access(
  { risk: "read" },
  tool({
...
export const get_user_assigned_issues = access(
  { risk: "read" },
  tool({
    description:
...
export const suspend_user = access(
...
export const unsuspend_user = access(
  { risk: "destructive", minRole: "admin" },
  tool({
...
export const invite_user = access(
  { risk: "destructive", minRole: "admin" },
  tool({
    description:
