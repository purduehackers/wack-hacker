...
export const list_cycles = access(
  { risk: "read" },
  tool({
    description:
...
export const create_cycle = access(
  { risk: "write" },
  tool({
    description:
...
export const update_cycle = access(
  { risk: "write" },
  tool({
...
export const archive_cycle = access(
  { risk: "destructive" },
  tool({
    description:
