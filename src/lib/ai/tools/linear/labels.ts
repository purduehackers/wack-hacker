...
export const list_labels = access(
  { risk: "read" },
  tool({
    description:
...
export const create_label = access(
  { risk: "write" },
  tool({
    description:
...
export const update_label = access(
  { risk: "write" },
  tool({
...
export const delete_label = access(
  { risk: "destructive" },
  tool({
    description:
