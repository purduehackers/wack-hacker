...
export const add_to_cart = access(
  { risk: "write" },
  tool({
    description:
...
export const remove_from_cart = access(
...
export const update_quantity = access(
  { risk: "write" },
  tool({
    description:
...
export const clear_cart = access(
  { risk: "write", confirm: "self" },
  tool({
    description:
