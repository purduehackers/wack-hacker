...
import type { SlashCommandContext } from "@/lib/bot/commands/types";

import { env } from "@/env";
import { defineCommand } from "@/lib/bot/commands/define";
import { respond } from "@/lib/bot/commands/helpers";
import { parseSubcommand } from "@/lib/bot/commands/registry";
import { PrivacyClient, PrivacyMode, PrivacyProject } from "@/lib/bot/integrations/privacy";
